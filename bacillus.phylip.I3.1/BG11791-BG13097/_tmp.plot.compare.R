  ...
  for( i in 1:length(files) ) {
     ...
     tr = read.nexus( file  );
     plot( tr, main=paste("BG11791-BG13097",file), show.node.label=T );
     plot( tr, main=paste("BG11791-BG13097",file), type="u" );
     plot( tr, main=paste("BG11791-BG13097",file), type="c", show.node.label=T  );
     i;
  }
