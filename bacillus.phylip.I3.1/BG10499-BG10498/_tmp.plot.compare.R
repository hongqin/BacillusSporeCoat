  ...
  for( i in 1:length(files) ) {
     ...
     tr = read.nexus( file  );
     plot( tr, main=paste("BG10499-BG10498",file), show.node.label=T );
     plot( tr, main=paste("BG10499-BG10498",file), type="u" );
     plot( tr, main=paste("BG10499-BG10498",file), type="c", show.node.label=T  );
     i;
  }
