# 062208 muscle prot-bacillus.faa
...
foreach my $mydir ( @clusterdirs ) {
  ...
  my $cmd1  =  "muscle -in prot-bacillus.faa -out prot-bacillus-aligned.fasta -stable ";
  system( $cmd1 );
  my $cmd1b =  "muscle -in prot-bacillus.faa -out prot-bacillus-aligned.aln   -stable -clw ";
  system( $cmd1b );
