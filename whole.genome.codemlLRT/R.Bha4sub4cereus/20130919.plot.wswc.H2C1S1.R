...
########2013 Sep 19, plot ws ~ wc for the two-step H2C1S1
 ...
 tbomegaH2C1S1 = tbomega[tbomega$V2=="H2C1S1",  ] #I have applied tree-dist yet. 
 ...
 pdf("ws_wc_20130919.pdf",width=5,heigh=5)
 with( picked.omega[!is.na(picked.omega$noCEflag),], 
       plot( V4 ~ V6, ylab=expression(paste(omega,s)), xlab=expression(paste(omega,c)),                                           
 ...
 #reivewer 2 comment, ws > wc? 2013 Sep 23
