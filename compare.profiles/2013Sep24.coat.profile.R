#2013 Sep 24, add spore coat location
...
setwd("~/projects/coat.protein07/ortholog.analysis/compare.profiles")
...
# ctb = read.csv( "_coat.profile.110808.csv");  #20130924
ctb = read.csv( "_coat.profile.122908.csv", sep="\t");  #20130924 change
...
#add coat location, 20130924
# rownames(ctb2) = as.character( paste(ctb$id, ctb$Gene) ); #20130924
ctb$LocationShort = ifelse(ctb$CoatLocation=='InnerCoat' | ctb$CoatLocation=='OuterCoat', 
                           as.character(ctb$CoatLocation), '')
rownames(ctb2) = as.character( paste(ctb$id, ctb$Gene, ctb$LocationShort )); #20130924
...
pdf("_20130924.average.hclust.2.coat.pdf", height=5, width=5); 
...
#grid lines disappears, I have to photoshop the labels to the old heatmap. 
