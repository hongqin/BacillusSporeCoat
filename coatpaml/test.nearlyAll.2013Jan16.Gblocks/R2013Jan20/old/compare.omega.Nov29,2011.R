...
# leaf brnaches for publication
BceClade = c("Bwe","Ban","Bth","Bce"); # p=0.4, 0.79 for w>1, 0.11 for w< 1 cCW>nCW

# internal branches for publication  ********
BceClade = c("(Bwe,Bce,Ban,Bth)","(Bce,Ban,Bth)","(Ban,Bth)","(Bwe,Bce,Bth)","(Bce,Bth)", "(Bwe,Ban,Bth)"); # p=?  cCW>nCW
...
FlagPartitionOmega = 0; #1 for w > 1, 2 for w<1
