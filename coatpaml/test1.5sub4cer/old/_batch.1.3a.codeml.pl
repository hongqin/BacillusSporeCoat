...
foreach my $mydir (@clusterdirs) {
  ...
  open( OUT, ">tree.H0.tre"); print OUT $H0tre."\n"; close (OUT);
  system( "cp $H0ctl codeml.H0.ctl" );
  system( "ln -sf ../../cds.phylip ." );
  system( "codeml codeml.H0.ctl");
  ...
  open( OUT, ">tree.H1.tre"); print OUT $H1tre."\n"; close (OUT);
  system( "cp $H1ctl codeml.H1.ctl" );
  system( "ln -sf ../../cds.phylip ." );
  system( "codeml codeml.H1.ctl");
  ...
  open( OUT, ">tree.H2.tre"); print OUT $H2tre."\n"; close (OUT);
  system( "cp $H2ctl codeml.H2.ctl" );
  system( "ln -sf ../../cds.phylip ." );
  system( "codeml codeml.H2.ctl");
