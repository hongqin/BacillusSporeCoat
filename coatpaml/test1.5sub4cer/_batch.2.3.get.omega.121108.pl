...
"(Bha,(Bpu,(Bli,(Bam ,(Bmo #1,Bsu #1)#1))),(Bwe,(Bce,(Ban,Bth))));", #H1a
"(Bha,(Bpu,(Bli,(Bam #1,(Bmo #1,Bsu #1)#1)#1)),(Bwe,(Bce,(Ban,Bth))));", #H1b
"(Bha,(Bpu,(Bli #1,(Bam #1,(Bmo #1,Bsu #1)#1)#1)#1),(Bwe,(Bce,(Ban,Bth))));", #H1c
"(Bha,(Bpu #1,(Bli #1,(Bam #1,(Bmo #1,Bsu #1)#1)#1)#1)#1,(Bwe,(Bce,(Ban,Bth))));", #H1d
"(Bha,(Bpu,(Bli,(Bam,(Bmo,Bsu)))),(Bwe,(Bce,(Ban #1,Bth #1)#1)));", #H2a
"(Bha,(Bpu,(Bli,(Bam,(Bmo,Bsu)))),(Bwe,(Bce #1,(Ban #1,Bth #1)#1)#1));", #H2b
"(Bha,(Bpu,(Bli,(Bam,(Bmo,Bsu)))),(Bwe #1,(Bce #1,(Ban #1,Bth #1 )#1)#1));", #H2c
"(Bha,(Bpu #2,(Bli #2,(Bam #2,(Bmo #2,Bsu #2)#2)#2)#2)#2,(Bwe #1,(Bce #1,(Ban #1,Bth #1)#1)#1)#1);", #H3a
#"(Bha,(Bpu #2,(Bli #2,(Bam #2,(Bmo #2,Bsu #2)#2)#2)#2),(Bwe #1,(Bce #1,Ban #1,Bth #1)#1));" #H3b
"(Bha,(Bpu ,(Bli,(Bam ,(Bmo ,Bsu )) ) ),                  (Bwe #2,(Bce #2,(Ban #1,Bth #2)#2)#2)#2 );", #H3c
"(Bha,(Bpu #3,(Bli#3, (Bam #3,(Bmo #3 ,Bsu #3)#3)#3)#3)#3,(Bwe #2,(Bce #2,(Ban #1,Bth #2)#2)#2)#2 );" #H4a
);
...
foreach my $mydir ( @clusterdirs ) {
  ...
  foreach my $i ( 0 .. $#Hs) {
   ...
   if ( $h eq 'H0' ) {
     ...
     my @els2 = split (/Bha #/, $sublines[1]);
     my ($bhaomega, @res2) = split (/\s+/, $els2[1]);
     my @els3 = split (/Bsu#3 #/, $sublines[1]);
     my ($bsuomega, @res3) = split( /\s+/, $els3[1]);
     my @els4 = split (/Bth#2 #/, $sublines[1]);
     my ($bthomega, @res3) = split( /\s+/, $els4[1]);
     push (@outlines, "$mydir\t$h\tAll\t$bhaomega\tBan\t$banomega\tBsu\t$bsuomega\tBth\t$bthomega");     
   } else { #error
     print "\nWARNING $mydir $h\n";
   } 
...
chdir $root; 
open( OUT, ">__omega.coat.120908.csv");
